# Generated by Django 5.0.6 on 2025-02-01 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appCourseWare.userlevel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='course',
            name='professor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='appCourseWare.professor'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('gpa', models.DecimalField(decimal_places=2, max_digits=4, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(20.0)])),
                ('max_units', models.PositiveIntegerField(default=0, editable=False)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('admission_year', models.PositiveIntegerField(choices=[('1403', 1403), ('1402', 1402), ('1401', 1401), ('1400', 1400), ('1399', 1399), ('1398', 1388)], default=1403)),
                ('major', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='appCourseWare.major')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('enrolled', 'ثبت نام شده'), ('pending', 'انتظار'), ('withdrawn', 'حذف اضطراری'), ('completed', 'گذرانده')], max_length=20)),
