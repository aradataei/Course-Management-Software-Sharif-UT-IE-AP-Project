# Generated by Django 5.0.6 on 2025-01-28 19:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='appCourseWare.userlevel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='appCourseWare.classroom')),
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('year', models.IntegerField(auto_created=1403, default=1403)),
                ('student_id', models.BigIntegerField(primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MinValueValidator(100000000), django.core.validators.MaxValueValidator(403999999)])),
                ('first_name', models.CharField(max_length=100)),
                ('last_name', models.CharField(max_length=100)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('national_id', models.CharField(max_length=10, unique=True)),
                ('phone_number', models.CharField(blank=True, max_length=10, null=True)),
                ('gpa', models.DecimalField(decimal_places=2, default=16, max_digits=4)),
                ('max_units', models.DecimalField(decimal_places=2, max_digits=5)),
                ('admission_year', models.IntegerField()),
                ('major', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appCourseWare.majors')),
